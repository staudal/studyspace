                ...
                <div className='w-full max-w-lg lg:max-w-xs'>
                  ...
                  <div className='relative'>
                    <input
                      ...
                      id='search'
                      placeholder='Search'
                      class='block w-full rounded-md border-0 py-1.5 pr-11 placeholder:text-gray-400 text-white bg-gray-900 ring-0 focus:ring-0 sm:text-sm sm:leading-6'
                    />
                    <div class='absolute inset-y-0 right-0 flex py-1.5 pr-1.5'>
                      <kbd class='inline-flex bg-gray-800 items-center rounded px-1 font-sans text-xs text-gray-400'>⌘K</kbd>
                    </div>
                  </div>
                </div>
              </div>
